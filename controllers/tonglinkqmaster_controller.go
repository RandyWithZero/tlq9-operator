...
type TongLinkQMasterReconciler struct {
	client.Client
	Log    logr.Logger
	Scheme *runtime.Scheme
}

//+kubebuilder:rbac:groups=tlq.tongtech.com,resources=tonglinkqmasters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=tlq.tongtech.com,resources=tonglinkqmasters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=tlq.tongtech.com,resources=tonglinkqmasters/finalizers,verbs=update
...
func buildMasterPod(master *tlqv1alpha1.TongLinkQMaster) *v1.Pod {
...
func (r *TongLinkQMasterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	c := ctrl.NewControllerManagedBy(mgr)
	watches := c.Watches(&source.Kind{Type: &v1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &tlqv1alpha1.TongLinkQMaster{},
	})
	return watches.For(&tlqv1alpha1.TongLinkQMaster{}).
		Complete(r)
}
